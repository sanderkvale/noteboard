...
const NoteTile = () => {
    return (
        <div className='w-full py-2 group grid grid-cols-8 max-w-screen-lg'>
            ...
            <div className='col col-span-6'>
                <p className='text-3xl text-[#8d8d8d] mb-3 font-semibold'>Lorem ipsum dolor sit amet, consectetur.</p>
